...
const (
	...
	httpOutgoingBodyWriteName       = "outgoing-body-write"
	httpOutgoingBodyFinishName      = "outgoing-body-finish"
	httpDropOutgoingBodyName        = "drop-outgoing-body"

	httpIncomingBodyStreamName      = "incoming-body-stream"
	httpIncomingBodyFinishName      = "incoming-body-finish"
	httpDropIncomingBodyName        = "drop-incoming-body"
